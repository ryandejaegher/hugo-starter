...
((demo of stagger animation)

Rather then just have them fade in all at once, we’re going to add a slight transition/delay to each item in the menu so that elements animate one at a time instead of all at once. It’s a subtle effect but looks really cool.
...
*Why are we doing this with JavaScript? Can’t we just animate with CSS.*
...
This will animate the opacity of the links from 0 to 1, which will cause them to “***fade in***”.
